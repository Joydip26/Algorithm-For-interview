...
public class TwoStringInterleavingToFormThird {
	...
	public boolean isInterleavedDynamic(char str1[], char str2[], char str3[]){
    ...
    public static void main(String args[]){
        ...
        System.out.println(sti.isInterleavedDynamic(str1.toCharArray(), str2.toCharArray(), str3.toCharArray()));
    }
