...
public class BooleanParenthesis {
	...
	public static int calculateNumberOfWaysDynamic(String operators, String operands) {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Number of ways to parenthisize expression : " + calculateNumberOfWaysDynamic(operators, operands));
